...
import (
	...
	"HFOperator/controllers/hlfmetrics"
...
const peerFinalizer = "finalizer.peer.hlf.zhangfuli.com"
...
const (
	deploymentRestartTriggerAnnotation = "com.zhangfuli.hlf.deployment-restart.timestamp"
)

// +kubebuilder:rbac:groups=hlf.zhangfuli.com,resources=fabricpeers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=hlf.zhangfuli.com,resources=fabricpeers/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=hlf.zhangfuli.com,resources=fabricpeers/finalizers,verbs=get;update;patch

// +kubebuilder:rbac:groups=hlf.zhangfuli.com,resources=fabricorderernodes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=hlf.zhangfuli.com,resources=fabricorderernodes/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=hlf.zhangfuli.com,resources=fabricorderernodes/finalizers,verbs=get;update;patch

// +kubebuilder:rbac:groups=hlf.zhangfuli.com,resources=fabricorderingservices,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=hlf.zhangfuli.com,resources=fabricorderingservices/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=hlf.zhangfuli.com,resources=fabricorderingservices/finalizers,verbs=get;update;patch

// +kubebuilder:rbac:groups=hlf.zhangfuli.com,resources=fabriccas,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=hlf.zhangfuli.com,resources=fabriccas/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=hlf.zhangfuli.com,resources=fabriccas/finalizers,verbs=get;update;patch
...
func (r *FabricPeerReconciler) upgradeChart(cfg *action.Configuration, err error, ns string, releaseName string, c *FabricPeerChart) error {
	inrec, err := json.Marshal(c)
	if err != nil {
		return err
	}
...
func GetConfig(conf *hlfv1alpha1.FabricPeer, client *kubernetes.Clientset, chartName string, namespace string, svc *corev1.Service, refreshCerts bool) (*FabricPeerChart, error) {
	...
	stateDb := "goleveldb"
	specStateDB := strings.ToLower(string(spec.StateDb))
	switch specStateDB {
	case string(hlfv1alpha1.StateDBCouchDB):
		stateDb = "CouchDB"
	case string(hlfv1alpha1.StateDBLevelDB):
		stateDb = "goleveldb"
	default:
		stateDb = "goleveldb"
	}
...
func createPeerService(clientSet *kubernetes.Clientset, chartName string, peer *hlfv1alpha1.FabricPeer) (*corev1.Service, error) {
