...
import (
	versioned "HFOperator/pkg/client/clientset/versioned"
	internalinterfaces "HFOperator/pkg/client/informers/externalversions/internalinterfaces"
	"context"
	time "time"

	hlfzhangfulicomv1alpha1 "HFOperator/api/hlf.zhangfuli.com/v1alpha1"
	v1alpha1 "HFOperator/pkg/client/listers/hlf.zhangfuli.com/v1alpha1"
...
func NewFilteredFabricOrderingServiceInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&hlfzhangfulicomv1alpha1.FabricOrderingService{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fabricOrderingServiceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&hlfzhangfulicomv1alpha1.FabricOrderingService{}, f.defaultInformer)
}
